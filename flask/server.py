...
def runAlg(inputData):
    ...
    if inputData:
        ...
        #print(categorize.mongoQ("Recreation","Sports","Fashion"))
        inputData=inputData.replace(u"\u2019","'")
        print("_____________________________________________________")
        print(inputData)
        # inputData=inputData.encode("ascii",errors='ignore')
        #inputData=inputData.decode("utf-8",errors='ignore')
        print("_____________________________________________________")
        return categorize.function_a(inputData)   
    else: 
        print("Not working??????")
